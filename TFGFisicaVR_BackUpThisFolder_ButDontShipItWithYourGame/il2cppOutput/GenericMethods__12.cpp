...
struct Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201 
{
...
// Method Definition Index: 2632
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Array_InternalArray__IndexOf_TisSegment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201_m1B57721C9DD2AD551F3F30167587B78FB14BB5A2_gshared (RuntimeArray* __this, Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201 ___0_item, const RuntimeMethod* method) 
{
	il2cpp_rgctx_method_init(method);
	int32_t V_0 = 0;
	int32_t V_1 = 0;
	Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201 V_2;
	memset((&V_2), 0, sizeof(V_2));
	{
		int32_t L_0;
		L_0 = Array_get_Rank_m9383A200A2ECC89ECA44FE5F812ECFB874449C5F(__this, NULL);
...
IL_0042:
	{
		Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201 L_5 = ___0_item;
		Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201 L_6 = L_5;
		RuntimeObject* L_7 = Box(il2cpp_rgctx_data_no_init(method->rgctx_data, 1), &L_6);
		Il2CppFakeBox<Segment_t5BF387A9E2A4D85E9317A5E1E89F0BEEDFAC5201> L_8(il2cpp_rgctx_data(method->rgctx_data, 1), (&V_2));
		bool L_9;
		L_9 = ValueType_Equals_mCA5344597A8055EC544855AD60A983B10E0EE67D((ValueType_t6D9B272BD21782F0A9A14F2E41F85A50E97A986F*)(&L_8), L_7, NULL);
		if (!L_9)
		{
